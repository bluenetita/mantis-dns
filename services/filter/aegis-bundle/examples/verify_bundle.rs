...
//! services/control/aegis_control/compiler/build_empty_bundle.py and verify it.
//!
//! Run from services/control: python -m aegis_control.compiler.build_empty_bundle
//! Then from repo root: cargo run -p aegis-bundle --example verify_bundle -- services/control/bundle.bin services/control/bundle_pubkey.bin

use aegis_bundle::{verify, Bundle};
