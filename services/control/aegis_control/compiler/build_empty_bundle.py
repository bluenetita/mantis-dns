...
Run: python -m aegis_control.compiler.build_empty_bundle
Produces bundle.bin + bundle_pubkey.bin in the working directory, which the
Rust side loads and verifies (see services/filter/aegis-bundle/examples/verify_bundle.rs).
"""
...
from aegis_control.compiler.signing import generate_keypair, sign_bundle, public_key_raw_bytes
