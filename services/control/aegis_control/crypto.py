...
secrets in plaintext in Postgres. Set AEGIS_WEBHOOK_SECRET_KEY before any
non-dev deployment.
"""
...
_KEY_ENV = "AEGIS_WEBHOOK_SECRET_KEY"
...
def _fernet() -> Fernet:
    ...
    if raw:
        ...
        # secrets without AEGIS_WEBHOOK_SECRET_KEY set — dev convenience only.
